    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Read (Multiple tables and columns)</h1>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				<div class="text-center">
					<code <p> SELECT * FROM tableName1 a, tablename2 b WHERE a.name=b.name </p> </code>
				</div>
			</div>
		</div>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>$data = "SELECT * FROM tableName2 a, tablename3 b WHERE a.name=b.name";</span>
				...
				<br />&nbsp;&nbsp;<span>&lt;tr&gt;</span>
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>&lt;th&gt;Name&lt;/th&gt;</span>
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>&lt;th&gt;Age&lt;/th&gt;</span>
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>&lt;th&gt;Favourite Food&lt;/th&gt;</span>
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>&lt;th&gt;Favourite Drink&lt;/th&gt;</span>
				<br />&nbsp;&nbsp;<span>&lt;/tr&gt;</span>
				<br />
				...
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>&lt;td&gt;&lt;?php echo $info['name']; ?&gt;&lt;/td&gt;</span>
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>&lt;td&gt;&lt;?php echo $info['age']; ?&gt;&lt;/td&gt;</span>
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>&lt;td&gt;&lt;?php echo $info['favouritefood']; ?&gt;&lt;/td&gt;</span>
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>&lt;td&gt;&lt;?php echo $info['favouritedrink']; ?&gt;&lt;/td&gt;</span>
				<br />&nbsp;&nbsp;<span>&lt;/tr&gt;</span>
				<br />
