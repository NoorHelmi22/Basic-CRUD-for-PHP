    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Delete (Single table and column)</h1>
                  ...
                  <tbody>
					...
					?>
							<tr>
								...
								<td><form action="deleteProcess.php" method="POST" onSubmit="return confirm('Are you sure want to delete <?php echo $info['columnName']; ?> ?')">
								<input type='hidden' value='<?php echo $info['columnName']; ?>' name='columnName'>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>$dataStore = $_POST['columnName'];</span>
				<br />
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #0000BB">//sql query for deleting the data in the database</span>
				<br />&nbsp;&nbsp;&nbsp;&nbsp;<span>$sql = "DELETE FROM tablename1 WHERE columnName ='$dataStore'" ;</span>
				<br />
